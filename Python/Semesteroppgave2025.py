...
draw_label_and_ticks()
# Try to load background map image relative to this file; fall back if missing
img_path = Path(__file__).with_name('StorBergen2.png')
img = None
if img_path.exists():
...
# Read rain data relative to this file, and split in train and test data
